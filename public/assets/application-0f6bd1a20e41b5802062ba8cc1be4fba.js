...
VA3C.attributes.populateAttributeList = function( jsonData ){
    ...
    VA3C.attributes.list.append('<input type="checkbox" value="1"></input>');
...
(function() {
  $(function() {
    $('.comments_interface').on('click', '.hide-comment', function() {
      return $.ajax($(this).data('comment_endpoint'), {
        type: 'PUT',
        data: {
          comment: {
            hidden: $(this).val()
    ...
    return $('.comments_interface').on('click', '.resolve-comment', function() {
      return $.ajax($(this).data('comment_endpoint'), {
        type: 'PUT',
        data: {
          comment: {
...
(function() {
  $(function() {
    $('.project-list').on('click', '.project-completion', function() {
      var completion_data;
      completion_data = {};
      completion_data[$(this).data('element_class')] = {
