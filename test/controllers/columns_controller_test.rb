...
class ColumnsControllerTest < ActionController::TestCase
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post :create, column: { angle: @column.angle, details: @column.details, done: @column.done, material: @column.material, revit_id: @column.revit_id, section: @column.section }
    end
  ...
  test "should update column" do
    patch :update, id: @column, column: { angle: @column.angle, details: @column.details, done: @column.done, material: @column.material, revit_id: @column.revit_id, section: @column.section }
    assert_redirected_to column_path(assigns(:column))
  end
